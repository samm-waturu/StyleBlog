...
export default function Navbar(props) {
    ...
    const rightmenu = [
        ...
        //  custom pulling from the left menu
        {
            label: "Contact",
            href: "/contact"
        }
                ...
                <Disclosure>
                    {({open}) => (
                        <>
                            <div className="flex flex-wrap justify-between md:flex-nowrap md:gap-10">
                                ...
                                <div className="flex w-full items-center justify-between md:w-auto">
                                    {/*If there is no logo image use the default stablo text*/}
                                    <Link href="/" className="w-28 dark:hidden">
                                        {/*fetch data from sanity - push to SSG*/}
                                        {props.logo ? (
                                            <Image
                        ...
                        Stablo
                            ...
                            <Disclosure.Panel>
                                <div
                                    className="order-2 -ml-4 mt-4 flex w-full flex-col items-center justify-start md:hidden">
