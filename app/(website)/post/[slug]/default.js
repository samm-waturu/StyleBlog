...
import Text from "@/components/blog/sharepost"
import CategoryLabel from "@/components/blog/category";
import AuthorCard from "@/components/blog/authorCard";
import DisqusComments from "@/components/blog/DisqusComments";

export default function Post(props, pathPrefix) {
                ...
                <article className="mx-auto max-w-screen-md ">
                    <div className="prose mx-auto my-3 dark:prose-invert prose-a:text-blue-600">
                        ...
                        <Text title={post.title}
                              slugFB={`https://style-book.vercel.app/post/${pathPrefix ? `${pathPrefix}/` : ""}${
                                  post.slug.current
                              }`} slugWA={`https://style-book.vercel.app/post/${pathPrefix ? `${pathPrefix}/` : ""}${
                            post.slug.current
                        }`}/>
                    </div>
                    ...
                    Where the custom comment section was entering
